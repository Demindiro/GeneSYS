...
Additionaly, there are supersets of 64 entries each, each superset having
...
Currently, only a maximum of 512G memory is supported.
A different strategy or a "super-superset" is likely prefereable
at and above 1T, especially considering NUMA.
